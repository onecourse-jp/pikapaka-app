...
export default function ServiceStep4() {
  ...
  const DATALISTPERSON2 = [
    ...
    {key: "content_allergies", label: "アレルギーの内容", value: dataConfirm.content_allergies || "アレルギー内容を入力"},
    {key: "take_medicines", label: "服薬中の薬の有無", value: dataConfirm.take_medicines || "選択", option: true},
    {key: "content_medicines", label: "服用中薬の内容", value: dataConfirm.content_medicines || "薬の内容をを入力"},
