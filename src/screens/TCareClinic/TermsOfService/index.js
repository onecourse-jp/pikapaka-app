  ...
  const container = [
    {
      title: "",
      content:
        "はじめに この度は、株式会社ピカパカの運営する「ピカパカヘルスケア」をご利用いただき、誠にありがとうございます。 以下の規約(以下、「本規約」といいます。)の内容をよくお読みいただいた上で、ピカパカヘルスケアをご利用いただきますよう宜しくお願い申し上げます。",
    },
   {
      title: "※注意事項",
      content:
        "ピカパカヘルスケアは、株式会社ピカパカが運営するオンライン診療支援サービスです。我々は医療機関ではなく、本サービスを利用したオンライン診療は、当社と提携している掲載医療機関に所属する医師が行います。我々は、オンライン診療を行う医師と患者をつなぐコミュニケーションのシステムを提供するベンダーです。 オンライン診療は、あくまでも対面診療を補完するものであるため、医師には、ビデオ通話と必要に応じて対面診療を適切に組み合わせて診療を実施することをお願いしております。",
    },
   {
      title: "第1条 適用",
      content:
    ...
    },
   {
      title: "第12条 暴力団等排除条項",
      content:
        "1.ユーザーは現在、暴力団、暴力団員、暴力団員でなくなった時から5年を経過しない者、暴力団準構成員、暴力団関係企業、総会屋等、社会運動等標ぼうゴロまたは特殊知能 暴力団等、その他これらに準ずる者(以下、これらを「暴力団員等」といいます。)に該当しないことを表明し、かつ将来にわたっても該当しないことを確約するものとします。\n2.ユーザーは自らまたは第三者を利用して次の各号の一にでも該当する行為を行わないことを確約するものとします。\n（1）暴力的な要求行為\n（2）法的な責任を超えた不当な要求行為\n（3）取引に関して、脅迫的な言動をし、または暴力を用いる行為\n（4）風説を流布し、偽計を用いまたは威力を用いて、当社、他の利用者、その他第三者の信用を毀損し、または当社、他の利用者、その他第三者の業務を妨害する行為（5）その他前各号に準ずる行為",
    },
   {
      title: "第13条 提供情報の利用 ",
      content:
