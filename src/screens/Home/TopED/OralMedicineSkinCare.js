...
export default function OralMedicineSkinCare() {
  ...
  const listMedicine = [
    ...
    },
    {
      ...
      name: "シナール",
      description: "シミの原因となる過剰なメラニンの生成を抑制し、肌に沈着してしまった黒色メラニンを無色化します。",
    },
    {
      image: require("@assets/images/medicine_skincare_3.png"),
      name: "ハイチオール",
      description: "皮膚の新陳代謝を促進することで、健康的な肌を保つことができます。",
    },
    {
    ...
    },
    {
      ...
      name: "エパデール（900）",
      description: "血液サラサラ（抗血栓）作用、ＬＤＬ降下・ＨＤＬ増加作用、抗がん作用、生活習慣病の予防改善。\n血管年齢を下げる。動脈硬化予防。魚の油。市販薬などのEPAと同成分、医療用で配合量が多い。",
    },
    {
  ...
  return (
    <View style={{backgroundColor: colors.white, borderRadius: 18, padding: 20, flexDirection: "column"}}>
      ...
      <TypeAndEffectOfInternalMedicine
        ...
        planDescription={["ホームケア内服薬。", "素肌のトラブル（しみ、そばかす、たるみ、しわ、くすみなど）の治療。医療用医薬品による高い効果が期待できます。"]}
        ...
        <View style={{}}>
          <Table borderStyle={{borderWidth: 1, borderColor: colors.buttonSkincare}}>
            ...
            <TableWrapper style={{flexDirection: "row"}}>
              <TableWrapper style={{flex: 1}}>
                <Col
                  data={[global.t("whitening_skin_aging_set"), global.t("the_strongest_whitening_skin_aging_set")]}
                  heightArr={[173, 209]}
                  style={{flex: 1, backgroundColor: colors.colorSkincare02}}
                  textStyle={{textAlign: "center", color: colors.textHiragino}}
                />
              ...
              <TableWrapper style={{flex: 3}}>
                <Row
                  ...
                  style={{fontSize: 13, lineHeight: 18, height: 28}}
                />
                <Row textStyle={{textAlign: "center"}}  data={[contentSkin1()]} style={{flex: 1, height: 133}} />
                <Row
                  textStyle={{textAlign: "center", color: colors.textHiragino}}
      ...
      <Text style={{marginTop: 8}}>{global.t("all_listed_prices_include_tax")}</Text>
      <View
        style={{
          marginTop: 20,
          height: 90,
