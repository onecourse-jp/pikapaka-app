    ...
    <>
      <View style={{flexDirection: "row", justifyContent: "space-between", alignItems: "center"}}>
        {item.option ? (
          <>
            <TouchableOpacity
              style={{marginRight: 6, minWidth: 120, flexDirection: "column", alignItems: "flex-end"}}
              onPress={() => {
                setShowPopup(true);
              }}
            >
              {valueData === 1 && <Text>{item.data ? item.data[0].label : "有"}</Text>}
              {valueData === 2 && <Text>{item.data ? item.data[1].label : "無"}</Text>}
            ...
            >
              ...
              <View>
                <TouchableOpacity style={{flexDirection: "row", alignItems: "center", paddingVertical: 12}} onPress={() => setValue(1)}>
                  ...
                  ></View>
                  <Text style={{fontFamily: fonts.NSregular, fontSize: 19, lineHeight: 20}}>{item.data ? item.data[0].label : "有"}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{flexDirection: "row", alignItems: "center", paddingVertical: 12}} onPress={() => setValue(2)}>
                  ...
                  ></View>
                  <Text style={{fontFamily: fonts.NSregular, fontSize: 19, lineHeight: 20}}>{item.data ? item.data[1].label : "無"}</Text>
                </TouchableOpacity>
              </View>
              <View style={{flexDirection: "row", alignItems: "center", justifyContent: "center", marginTop: 30}}>
                ...
                >
                  <Text style={{fontFamily: fonts.NSregular, fontSize: 19, lineHeight: 20}}>Cancel</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={{
                    flexDirection: "row",
                ...
                >
                  <Text style={{fontFamily: fonts.NSregular, fontSize: 19, lineHeight: 20, color: colors.textBlue}}>Choose</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
